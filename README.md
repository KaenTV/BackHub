...
git clone https://github.com/KaenTV/BackHub.git
cd BackHub
...
# Compiler l'application (sans publier)
npm run build:win

# Compiler et publier sur GitHub
...
2. **Obtenir un token GitHub** :
   ...
   - Copiez le token dans le fichier `.env`
...
```
BackHub/
├── app/                    # Code Electron (processus principal)
...
│   │   ├── services/     # Services (API, storage, sync, etc.)
...
### Core
- **Electron** ^39.0.0 - Framework pour applications desktop
- **Node.js** - Runtime JavaScript

### Mise à jour
- **electron-updater** ^6.6.2 - Système de mise à jour automatique

### Build
- **electron-builder** ^26.0.12 - Compilation et packaging
- **cross-env** ^10.1.0 - Variables d'environnement cross-platform
- **dotenv-cli** ^11.0.0 - Gestion des variables d'environnement

### Stockage
- **electron-store** ^10.0.0 - Stockage local persistant
